                ...
                >
                  ...
                  <div>
                    <button
                      ...
                      }inline-flex items-center px-6 py-3 shadow-sm text-base font-medium rounded-md text-white bg-gradient-to-r from-green-400 to-blue-500 filter hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-400 focus:ring-offset-gray-900`}
                    >
                      {loading ? (
                        <svg
